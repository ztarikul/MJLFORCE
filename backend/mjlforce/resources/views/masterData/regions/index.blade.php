                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button class="btn btn-success btn-sm"
                                                        onclick="element_edit('{{ $region->id }}')"><i
                                                            class="fa fa-edit"></i></button>
                                                    <button class="btn btn-danger btn-sm"
                                                        onclick="element_delete('{{ $region->id }}')"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addForm').submit(function(e) {
                ...
                $.confirm({
                    title: 'Confirm!',
                    content: 'Are you sure you want to add this region?',
                    btnClass: 'btn-blue',
                    buttons: {
                        confirm: {
                            btnClass: 'btn-blue',
                            action: function() {
                                $.ajax({
                                    type: "POST",
                                    url: "{{ route('masterData.regions_store') }}",
                                    data: formData,
                                    contentType: false,
                                    processData: false,
                                    cache: false,
                    ...
                    buttons: {
                        confirm: {
                            ...
                            action: function() {
                                $.ajax({
                                    type: "POST",
                                    url: "{{ url('masterData/regions_update') }}" +
                                        "/" + id,
                                    data: formData,
                                    contentType: false,
                                    processData: false,
        ...
        function element_edit(id) {
            $.ajax({
                type: "GET",
                url: "{{ url('masterData/regions_edit') }}" + "/" + id,
                success: function(res) {
                    if (res.status === 'success') {
                        console.log(res.region)
                        $('#edit_id').val(res.region.id);
                        $('#edit_name').val(res.region.name);
                        $('#edit_code').val(res.region.code);
                        $('#edit_sap_code').val(res.region.sap_code);
                        $('#edit_description').val(res.region.description);
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function() {
                            $.ajax({
                                type: "GET",
                                url: "{{ url('masterData/regions_delete') }}" +
                                    "/" + id,
                                contentType: false,
                                processData: false,
                                cache: false,
