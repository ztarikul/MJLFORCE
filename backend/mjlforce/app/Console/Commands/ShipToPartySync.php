...
class ShipToPartySync extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'shipToPartySync';
    ...
    public function handle()
    {
        ...
        try {
            ...
            $response_shipToParty = $client->get('http://10.24.242.9:56000/RESTAdapter/CustomerList', [
                'auth' => ['sappo_app_user', 'LpYUQ93ITgkE'], // Basic Auth
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-Type' => 'application/json',
        ...
        $json_shipToParty = json_decode($response_shipToParty->getBody(), true);
        // print_r($json_soldToParty);
        // die();
