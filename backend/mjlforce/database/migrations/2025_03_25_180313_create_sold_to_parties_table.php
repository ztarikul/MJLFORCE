...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sold_to_parties', function (Blueprint $table) {
            $table->id();
            $table->integer('customer_code')->nullable()->unique()->comment('KNA1-KUNNR');
            $table->string('customer_acc_group')->nullable()->comment('KNA1-KTOKD');
            $table->integer('company_code')->nullable()->comment('KNB1-BUKRS');
            $table->integer('sales_org')->nullable()->comment('KNVV-VKORG');
            $table->integer('distribution_ch')->nullable()->comment('KNVV-VTWEG');
            $table->integer('division')->nullable()->comment('KNVV-SPART');
            $table->string('acc_name')->nullable()->comment('ADRC-NAME1');
            $table->string('acc_name2')->nullable()->comment('ADRC-NAME2');
            $table->string('search_term')->nullable()->comment('ADRC-SORT1');
            $table->string('search_term2')->nullable()->comment('ADRC-SORT2');
            $table->string('legacy_acc_code')->nullable()->comment('BUTOOO-BPEXT');
            $table->string('country')->nullable()->comment('ADRC-COUNTRY');
            $table->string('region')->nullable()->comment('ADRC-REGION');
            ...
            $table->string('address')->nullable()->comment('ADRC-STREET');
            $table->string('ceo')->nullable()->comment('ADRC-NAME_CO');
            $table->string('address_2')->nullable()->comment('ADRC-STR_SUPPL3');
            $table->string('address_3')->nullable()->comment('ADRC-LOCATION');
            ...
            $table->string('contact_mobile')->nullable()->comment('ADRC2-TEL_NUMBER');
            ...
            $table->string('fi_payment_terms')->nullable()->comment('KNB1-ZTERM');
            $table->string('currency')->nullable()->comment('KNVV-WAERS');
            $table->string('cust_pricing_procedure')->nullable()->comment('KNVV-KALKS');
            ...
            $table->string('incoterms')->nullable()->comment('KNVV-INCO1');
            $table->string('incoterms_loc_1')->nullable()->comment('KNVV-INCO2_L');
            $table->string('sd_payment_terms')->nullable()->comment('KNVV-ZTERM');
            $table->string('acc_assignment_group')->nullable()->comment('KNVV-KTGRD');
            $table->string('tax_classification')->nullable()->comment('KNVI-TAXKD');
